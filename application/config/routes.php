...
$route['admin/updateRekamMedis']        = 'C_admin/updateDataRekamMedis';
$route['admin/tambahRekamMedis']        = 'C_admin/tambahRekamMedis';
$route['admin/getRekamMedis/(:num)']        = 'C_admin/getRekamMedis/$1';
$route['admin/hapusDataRekamMedis/(:num)']        = 'C_admin/hapusDataRekamMedis/$1';
$route['admin/logbookRekamMedis/(:num)']        = 'C_admin/logbookRekamMedis/$1';

$route['admin_validator/logbookRekamMedis/(:num)']        = 'C_admin_validator/logbookRekamMedis/$1';
