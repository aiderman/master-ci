...
<aside id="leftsidebar" class="sidebar">
    <div class="menu">
        <ul class="list">
            ...
            <?php if ($role_id == 1) : ?>
                <a href="<?= base_url(); ?>user/logbook" id="logbook"><i class="zmdi zmdi-home"></i><span>Logbook</span></a></li>
            ...
            <?php elseif ($role_id == 2) : ?>
                <li><a href="<?= base_url(); ?>admin/logbook" id="logbook"><i class="zmdi zmdi-home"></i><span>Logbook</span></a></li>
            ...
            <?php elseif ($role_id == 3) : ?>
                <li><a href="<?= base_url(); ?>admin_validator/logbook" id="logbook"><i class="zmdi zmdi-home"></i><span>Logbook</span></a></li>
